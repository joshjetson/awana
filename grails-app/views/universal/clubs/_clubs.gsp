                            ...
                            <div class="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                                ...
                                <div class="flex justify-between mt-3">
                                    ...
                                    <button hx-delete="/delete?domainName=Club&id=${club.id}" 
                                            ...
                                            hx-swap="delete"
                                            hx-confirm="⚠️ DELETE CLUB: ${club.name?.encodeAsJavaScript()}

This will permanently remove:
• All club settings and information
• Student assignments to this club
• Book assignments to this club

Students and books will NOT be deleted, but their club assignments will be removed.

This action cannot be undone. Are you absolutely sure you want to delete this club?"
