    ...
    <div>
        ...
        <g:else>
            <div class="text-center py-8 text-gray-500">
                ...
                <p>No students found in ${club?.name ?: 'this club'}.</p>
...
<g:else>
    <div class="bg-white rounded-xl shadow-lg p-6 text-center">
        ...
        <h2 class="text-xl font-semibold text-gray-600 mb-2">No Club Selected</h2>
        <p class="text-gray-500">Please select a club to view its details and students.</p>
    </div>
</g:else>
